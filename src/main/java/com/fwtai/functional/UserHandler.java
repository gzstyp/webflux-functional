...
public class UserHandler {
    ...
    */
    public Mono<ServerResponse> getAll(ServerRequest request) {
        ...
        final Flux<User> customers = customerRepository.getAllUsers();
        // build response
    ...
    public Mono<ServerResponse> getUser(ServerRequest request) {
        ...
        // build response
        return customerMono.flatMap(customer -> ServerResponse.ok().contentType(MediaType.APPLICATION_JSON).body(fromObject(customer)))
    ...
    public Mono<ServerResponse> postUser(ServerRequest request) {
        final Mono<User> customer = request.bodyToMono(User.class);
    ...
    public Mono<ServerResponse> putUser(ServerRequest request) {
        ...
        // build response
        return responseMono.flatMap(cust -> ServerResponse.ok().contentType(MediaType.APPLICATION_JSON).body(fromObject(cust)));
    }
    ...
    public Mono<ServerResponse> deleteUser(ServerRequest request) {
        ...
        // build response
        return responseMono.flatMap(strMono -> ServerResponse.ok().contentType(MediaType.TEXT_PLAIN).body(fromObject(strMono)));
    }
}